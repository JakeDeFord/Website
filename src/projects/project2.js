    ...
    return (
        <div className="project-content"> {/* Apply the project-content class */}
            ...
            <p>
                ...
                <br /> {/* Add a line break before the hyperlink */}
                {/* Add your hyperlink here */}
                For more information, you can visit our project <a href="https://github.com/RIT-MSD-P21015" style={{ color: 'blue' }}>Github</a>.
            </p>
